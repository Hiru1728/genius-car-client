    ...
    return (
        <div>
            <form onSubmit={handlePlaceOrder}>
                ...
                <div className='input-bordered grid grid-cols-1 lg:grid-cols-2 gap-4'>
                    <input name='firstName' type="text" placeholder="First Name" className="input-bordered input input-ghost w-full" />
                    <input name='lastName' type="text" placeholder="Last Name" className="input-bordered input input-ghost w-full" />
                    <input name='phone' type="text" placeholder="Your Phone" className="input-bordered input input-ghost w-full" required />
